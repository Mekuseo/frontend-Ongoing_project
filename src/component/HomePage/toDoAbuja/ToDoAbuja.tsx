...
const ToDoAbuja: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="todoabujahome">
        <div className="topDesSub">
          ...
          <div className="centeredSub">
            Enjoy your holiday in a discreet and well savoured location.
          </div>
      ...
      <div className="todoabujapageconthome">
        <div className="todoabujapageconthomecontent">
