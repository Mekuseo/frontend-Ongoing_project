...
import LastDealsCards from './cards';

const LastDeals: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="topDesSub">
        ...
        <h1>
          Top Hotel Deals in Abuja
        </h1>

        <div className="centeredSub">
          We reserve hotels that fulfil all your travel needs. We get you the best deals
        </div>
