...
import '../travelNews/travelNew.css'
import '../topDes/topDes.css'
import '../LastMdeals/lastDeals.css'
...
const WaysToCards = () => {
    ...
    return (
      <>
        <div className="lastDealsCardsCont">
            <div className="footerow">
            {cards1.map((card, index) => (
                <div key={card.id} className="cardColsFirst">
                <div className="cardhomefirstLastdeals">
                    <h3>{card.name}</h3>
                    ...
                    <div className="likecardhomefirst">
                        ...
                        <svg
                            ...
                            viewBox="0 0 20 18"
                            fill="none"
                            className={isLiked[index] ? 'hearthome likedhomeheart' : 'hearthome'}
                        >
                            <path
                    ...
                    <a href={card.href}>
                        <div className="homecardDetails">
                            <div>
                                <div className="hoteltaghome">
                                    Hotels
                                </div>
                            </div>

                            <div className="rightdetails">
                                <div className="homestarcontainer">
                                    {card.icon}
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="stateoflocation">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="none">
                                            <g clip-path="url(#clip0_6985_10454)">
                                                <path d="M5.625 7.375C5.625 7.87228 5.82254 8.34919 6.17417 8.70083C6.52581 9.05246 7.00272 9.25 7.5 9.25C7.99728 9.25 8.47419 9.05246 8.82583 8.70083C9.17746 8.34919 9.375 7.87228 9.375 7.375C9.375 6.87772 9.17746 6.40081 8.82583 6.04917C8.47419 5.69754 7.99728 5.5 7.5 5.5C7.00272 5.5 6.52581 5.69754 6.17417 6.04917C5.82254 6.40081 5.625 6.87772 5.625 7.375Z" stroke="#263238" stroke-linecap="round" stroke-linejoin="round"/>
                                                <path d="M11.0356 10.9106L8.38375 13.5625C8.14937 13.7966 7.8313 15 7.5 15C7.1687 15 6.85126 13.7966 6.61688 13.5625L3.96438 10.9106C3.26514 10.2114 2.78896 9.32044 2.59606 8.35054C2.40315 7.38064 2.50218 6.37532 2.88063 5.46171C3.25908 4.54809 3.89994 3.76721 4.72218 3.21782C5.54442 2.66842 6.51111 2.37518 7.5 2.37518C8.4889 2.37518 9.45559 2.66842 10.2778 3.21782C11.1001 3.76721 11.7409 4.54809 12.1194 5.46171C12.4978 6.37532 12.5969 7.38064 12.4039 8.35054C12.211 9.32044 11.7349 10.2114 11.0356 10.9106Z" stroke="#263238" stroke-linecap="round" stroke-linejoin="round"/>
                                            </g>
                                            <defs>
