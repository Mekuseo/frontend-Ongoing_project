...
import './form.css';
import PicUpload from './picturesUpload';

interface PictureProps {
  onImageUpload: (imageSrc: string) => void;
}

const Pictures: React.FC<PictureProps> = ({ onImageUpload }) => {
  ...
  return (
    <div className='picsCont'>
      <p>Upload pictures for this event</p>
      <div>
        ...
        <a href='https://www.canva.com/templates' onClick={handleLinkClick}>
          <label className="datesContainer">
            Use Canva
